...
public void test_05() {assertEquals("Not correct", multiply(6.0, 2.0, 2.0), 24.0, 0.09);}

@Test // @Ignore

public void test_06() {assertEquals("Not correct", multiply(8.0, 5.0, 2.0), 80.0, 0.09);}

@Test // @Ignore

public void test_07() {assertEquals("Not correct", divide(90.0, 7.0), 12.9, 0.09);}

@Test // @Ignore

public void test_08() {assertEquals("Not correct", add(60.0, 5.0, 7.0), 72.0, 0.09);}

@Test // @Ignore

public void test_09() {assertEquals("Not correct", add(60.0, 5.0, 7.0), 72.0, 0.09);}

@Test // @Ignore

public void test_10() {assertEquals("Not correct", subtract(100.0, 22.0), 78.0, 0.09);}
